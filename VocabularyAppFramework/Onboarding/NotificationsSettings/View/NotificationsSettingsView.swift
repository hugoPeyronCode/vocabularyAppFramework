...
struct NotificationsSettingsView: View {
  ...
  let notificationManager = Self.NotificationManager.shared
  ...
  var TriggerNotificationButton: some View {
    MoveToNextPageButton(isActive: .constant(true)) {
      notificationManager.handleNotificationPermission(
        preferredTime: selectedTime,
        sound: selectedSound
      ) { granted, isFirstTime in
        vm.moveToNextPage()
      }
    }
  }
